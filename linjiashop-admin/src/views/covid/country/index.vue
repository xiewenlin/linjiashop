  ...
  <div class="app-container">
    <div class="block">
        ...
        <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" border fit highlight-current-row
          ...
          <el-table-column label="累计确诊人数">
            <template slot-scope="scope">
              {{scope.row.count}}
            </template>
          </el-table-column>
          <el-table-column label="累计死亡人数">
            <template slot-scope="scope">
              {{scope.row.deadCount}}
            </template>
          </el-table-column>
      ...
      <el-dialog
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="150px">
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="累计确诊人数" prop="count">
                <el-input type="number" v-model="form.count" minlength=1></el-input>
              </el-form-item>
            </el-col>


            <el-col :span="12">
              <el-form-item label="累计死亡人数">
                <el-input type="number" v-model="form.deadCount"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-form-item>
